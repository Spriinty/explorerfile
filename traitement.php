...
// // Position initiale dans l'arbre = rootprojet
...
// 		$d = dir($_SERVER['rootprojet'].$_GET['chemin']);
// 		// change de dossier avec chdir et pointe dessus
// 		chdir($_SERVER['rootprojet'].$_GET['chemin']);
// 	// Si pas $_GETchemin positionne directory sur adresse serveur
// 	} else {
// 		$d = dir($_SERVER['rootprojet']);
// 		chdir($_SERVER['rootprojet']);
// 	}
